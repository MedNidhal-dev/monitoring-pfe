...
const ObservabilityPage = () => {
  ...
  // tous les dashboards grafana
    ...
    { 
      ...
      url: "http://192.168.75.129:3000/d/dfir1mtd9c4qob/system-health-e28094-solife?orgId=1&refresh=30s&kiosk&refresh=5s",
    ...
    { 
      ...
      url: "http://192.168.75.129:3000/d/cfiqyup6m4hkwa/logs-and-incidents-e28094-solife?orgId=1&refresh=10s&kiosk&refresh=5s",
      icon: <Layout size={20} />,
